...
os.chdir('/home/sukhee/paper/Ubuntu Mar')
...
model_10.add(LSTM(units = 50, input_shape=(1, look_back)))
...
model_10.fit(trainX_10,  trainY_10, epochs=n_epoches, batch_size=25, verbose=2)
...
model_25.fit(trainX_25, trainY_25, epochs=n_epoches, batch_size=25, verbose=2)
...
model_50.fit(trainX_50, trainY_50, epochs=n_epoches, batch_size=25, verbose=2)
...
model_80.fit(trainX_80, trainY_80, epochs=n_epoches, batch_size=25, verbose=2)
...
df.to_csv("Soil moisture at.csv")
...
plt.plot(testY_50, c = 'green', label = 'Actual')
plt.xlabel('Time')
...
plt.plot(dataset_10, c = 'g', label = ' 10 m' )
plt.plot(dataset_25, c = 'blue', label = ' 25 m' )
plt.plot(dataset_50, c = 'y', label = ' 50 m' )
plt.plot(dataset_80, c = 'brown', label = ' 80 m' )
plt.xlabel('Time')
plt.ylabel('Moisture level')
plt.title('Soil moisture at different depth')
plt.legend()
plt.savefig('Soil moisture at different depth orginial ')
plt.show()
...
print("************  10m  ************ 10m  ************ 10m  ************")
mape_10= mean_absolute_percentage_error(df_A_10m, df_P_10m )
mae_10 = mean_absolute_error(df_A_10m, df_P_10m)
mse_10 = mean_squared_error(df_A_10m, df_P_10m)
rmse_10 = sqrt(mse_10)
print("\tMean absolute percentage error  :",mape_10)
print("\n\tMean  Squared Error  :",mse_10)
print("\n\tMean  Absolute Error  :",mae_10)
print("\n\tRoot Mean  Absolute Error  :",rmse_10)
print("*****************************************************************")

print("\n\n************  25m  ************ 25m  ************ 25m  ************")
mape_25= mean_absolute_percentage_error(df_A_25m, df_P_25m )
mae_25 = mean_absolute_error(df_A_25m, df_P_25m)
mse_25 = mean_squared_error(df_A_25m, df_P_25m)
rmse_25 = sqrt(mse_25)
print("\tMean absolute percentage error  :",mape_25)
print("\n\tMean  Squared Error  :",mse_25)
print("\n\tMean  Absolute Error  :",mae_25)
print("\n\tRoot Mean  Absolute Error  :",rmse_25)
print("*****************************************************************")



print("\n\n************  50m  ************ 50m  ************ 50m  ************")
mape_50= mean_absolute_percentage_error(df_A_50m, df_P_50m )
mae_50 = mean_absolute_error(df_A_50m, df_P_50m)
mse_50 = mean_squared_error(df_A_50m, df_P_50m)
rmse_50 = sqrt(mse_50)
print("\n\n\tMean absolute percentage error  :",mape_50)
print("\n\tMean  Squared Error  :",mse_50)
print("\n\tMean  Absolute Error  :",mae_50)
print("\n\tRoot Mean  Absolute Error  :",rmse_50)
print("*****************************************************************")
...
print("\n\n************  80m  ************ 80m  ************ 80m  ************")
mape_80= mean_absolute_percentage_error(df_A_80m, df_P_80m )
mae_80 = mean_absolute_error(df_A_80m, df_P_80m)
mse_80 = mean_squared_error(df_A_80m, df_P_80m)
rmse_80 = sqrt(mse_80)
print("\n\n\tMean absolute percentage error  :",mape_80)
print("\n\tMean  Squared Error  :",mse_80)
print("\n\tMean  Absolute Error  :",mae_80)
print("\n\tRoot Mean  Absolute Error  :",rmse_80)
print("*****************************************************************")



#df = pandas.concat([mape_80, mae_80], axis =1)


#df.to_csv("error rate Soil moisture at.csv")
